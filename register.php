...
// register.php is public to everyone.
...
if (isset($_POST['submit'])) {
  if (register($_POST['username'], $_POST['email'], $_POST['password'], $_POST['antispam'])) {
      ...
      <p style="max-width: 300px;margin: 0 auto 20px auto;"><a href="index.php">&larr; Back to <?php echo APP_NAME; ?></a></p>
        <div class="panel panel-default centering box">
          <div class="panel-heading">
            <h3 class="panel-title center">Super Simple Registration</h3>
          </div>
          <div class="panel-body">
            <?php echo $errorMsg; ?>
            <form accept-charset="UTF-8" role="form" enctype="application/x-www-form-urlencoded" method="post" action="register.php">
              <fieldset>
                <div class="form-group">
                  <input class="form-control gray-bg" placeholder="Enter username.." name="username" type="text">
                </div>
                <div class="form-group">
                  <input class="form-control gray-bg" placeholder="Enter password.." name="password" type="password">
                </div>
                <div class="form-group">
                  <input class="form-control gray-bg" placeholder="Enter email address.." name="email" type="email">
                </div>
