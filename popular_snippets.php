...
// popular_snippets.php is public.
...
if ($authenticated == false) {
    $query = "SELECT * FROM ".DBTABLE_SNIPPETS." WHERE visibility='public' ORDER BY view_count DESC LIMIT 20";
            ...
            <div class="col-md-9" id="rightSide">
                <div class="panel panel-default box">
                    <div class="panel-heading" id="contentHeading">
                        <i class="fa fa-list-alt"></i> Top 20 Popular Snippets
                    </div>
