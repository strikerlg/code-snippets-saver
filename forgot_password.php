...
// forgot_password.php is public to everyone.
...
if (isset($_POST['submit'])) {
  if (request_reset_password($_POST['email'])) {
      ...
      <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-default centering">
          <div class="panel-heading">
            <h3 class="panel-title center">Forgot Password</h3>
          </div>
          <div class="panel-body">
            <?php echo $errorMsg; ?>
            <form accept-charset="UTF-8" role="form" enctype="application/x-www-form-urlencoded" method="post" action="forgot_password.php">
              <fieldset>
                <div class="form-group">
                  <input class="form-control gray-bg" placeholder="Enter your email address.." name="email" type="email">
                  <p class="help-block" style="font-size:80%">A new reset password will sent to your email.</p>
                </div>
                <button class="btn btn-lg btn-success btn-block" type="submit" name="submit">Reset Password</button>
              </fieldset>
            </form>
            <hr>
