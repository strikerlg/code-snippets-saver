...
// change_email.php is only accessible for logged in users.
...
if (isset($_POST['submit'])) {
  if (change_email($_POST['username'], $_POST['current_password'], $_POST['new_email'])) {
      ...
      <p style="max-width: 300px;margin: 0 auto 20px auto;"><a href="index.php">&larr; Back to <?php echo APP_NAME; ?></a></p>
        <div class="panel panel-default centering">
          ...
          <div class="panel-body">
            <?php echo $errorMsg; ?>
            <form accept-charset="UTF-8" role="form" enctype="application/x-www-form-urlencoded" method="post" action="change_email.php">
              <fieldset>
                <div class="form-group">
                  <input class="form-control gray-bg" placeholder="Enter current password.." name="current_password" type="password">
                </div>
                <div class="form-group">
                  <input class="form-control gray-bg" placeholder="Enter new email address.." name="new_email" type="email">
                </div>
