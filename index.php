            ...
            <div class="col-md-9" id="rightSide">
                <div class="panel panel-default box">
                    ...
                    <div class="panel-body" id="content">
                        <h3>What is this?</h3>
                    	<p><strong><?php echo APP_NAME; ?></strong> is a PHP application built with jQuery and MySQL database to store your code snippets for your own future reference. It supports automatic code syntax highlighting built with <a href="https://highlightjs.org/" target="_blank">highlight.js</a> and private snippets which are accessible only to you. Public snippets are accessible to anyone and you can share its URL to your friends.</p>
                        <h3>How it works?</h3>
                        <p>To submit a snippet, user needs to log in first. If user doesn't register yet, user needs to register first. After logged in, user can go to "Submit a Snippet" link on the top menu to start submitting the snippet. User can choose to set the snippet's visibility to public (default) or private.</p>                    </div>
